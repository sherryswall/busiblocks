...
{
    /// <summary>
    /// ForumsProvider abstract class.
    /// Defines the contract that BusiBlocks implements to provide forum services using custom forum providers.
    /// Using this class you can insert, delete or read forum category, topic and messages.
    /// The main implementations is provided by the BusiBlocksForumsProvider class.
    /// </summary>
    public abstract class ForumsProvider : ProviderBase
    {
