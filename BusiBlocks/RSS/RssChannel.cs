...
namespace SyndicationLibrary.RSS
{
    ...
    public class RssChannel
    {
        ...
        /// </summary>
        private readonly Collection<RssCategory> channelCategories = new Collection<RssCategory>();

        /// <summary>
        /// Private member to hold collection of items associated to channel
        /// </summary>
        private readonly Collection<RssItem> channelItems = new Collection<RssItem>();
        ...
        [XmlElement(ElementName = "copyright", Type = typeof (String))]
        ...
        [XmlElement(ElementName = "docs", Type = typeof (String))]
        public string Documentation
        {
            get { return channelDocumentation.AbsoluteUri; }
        ...
        [XmlElement(ElementName = "generator", Type = typeof (String))]
        ...
        {
            get { return (channelCategories.Count > 0); }
        }
        ...
        [XmlElement(ElementName = "language", Type = typeof (String))]
        ...
        [XmlElement(ElementName = "lastBuildDate", Type = typeof (String))]
        public string LastBuildDateStr
        {
            get { return Rfc822DateTime.ToString(channelLastBuildDate); }
        ...
        [XmlElement(ElementName = "link", Type = typeof (String))]
        public string Link
        {
            get { return channelLink.AbsoluteUri; }
        ...
        [XmlElement(ElementName = "managingEditor", Type = typeof (String))]
        ...
        /// <value>Publication date for the content in the channel</value>
        /// <remarks>RFC822 Format</remarks>
        [XmlElement(ElementName = "pubDate", Type = typeof (String))]
        public string PublicationDateStr
        {
            get { return Rfc822DateTime.ToString(channelPublicationDate); }
        ...
        [XmlElement(ElementName = "rating", Type = typeof (String))]
        public string Rating
        {
            get { return channelRating; }
        ...
        [XmlElement(ElementName = "ttl", Type = typeof (Int32))]
        public int TimeToLive
        {
            get { return channelTimeToLive; }
        ...
        [XmlElement(ElementName = "webMaster", Type = typeof (String))]
        public string WebMaster
        {
            get { return channelWebMaster; }
