...
{
    /// <summary>
    /// A implementation of a System.Web.Profile.ProfileProvider class that use the BusiBlocks classes.
    ...
    /// </summary>
    public class BusiBlocksProfileProvider : ProfileProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            if (name == null || name.Length == 0)
                name = "BusiBlocksProfileProvider";
