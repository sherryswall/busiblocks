...
public partial class Controls_SearchResult : System.Web.UI.UserControl
{
    ...
    /// 
    /// </summary>
    /// <param name="entities">Must be a list of BusiBlocks.ISearchResult entities (like Message or Article)</param>
    ...
    public delegate Navigation.NavigationPage SearchEntityUrlDelegate(BusiBlocks.ISearchResult entity);
    public event SearchEntityUrlDelegate SearchEntityUrlCallback;

    protected string GetViewUrl(BusiBlocks.ISearchResult entity)
    {
