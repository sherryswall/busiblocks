...
public partial class Communication_TopicList : System.Web.UI.UserControl
{
    ...
    public void LoadList()
    {
        ...
        BusiBlocks.PagingInfo paging = new BusiBlocks.PagingInfo(LIST_PAGING_SIZE, CurrentPage);
        IList<BusiBlocks.CommsBlock.Forums.Topic> topics = BusiBlocks.CommsBlock.Forums.ForumsManager.GetTopics(category,
                                                    paging);

        List<BusiBlocks.CommsBlock.Forums.Topic> allowedTopics = new List<BusiBlocks.CommsBlock.Forums.Topic>();
    ...
    protected string GetViewTopicUrl(string idTopic)
    {
        ...
        return Navigation.Communication_ForumViewTopic(idTopic).GetClientUrl(this, true);
