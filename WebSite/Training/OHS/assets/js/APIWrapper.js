...
//alert("entered doLMSInitialize function");
//alert("about to call getAPIHandle function");   
...
//alert("result of LMSInitialization: " + result.toString());
   if (result.toString() != "true")
   {
      var err = ErrorHandler("doLMSInitialize");
   }
...
function doLMSFinish()
{
   ...
   else
   {
      ...
      if (result.toString() != "true")
      {
         var err = ErrorHandler("doLMSFinish");
      }
...
function doLMSSetValue(name, value)
{
   ...
   else
   {
      ...
      if (result.toString() != "true")
      {
		var myErrorType = "name: " + name + " | value: " + value;          
		var err = ErrorHandler(myErrorType);
      }
   }
...
function doLMSCommit()
{
   ...
   else
   {
      ...
      if (result != "true")
      {
         var err = ErrorHandler("doLMSCommit");
      }
   }
...
//alert("Entered LMSIsInitialised() function");
   var api = getAPIHandle();
   if (api == null)
   {
...
function ErrorHandler(x)
{
   ...
   if (errCode != _NoError)
   {
      ...
      alert(errDescription + " | The Error was called by: " + x);
   }
...
function getAPIHandle()
{
//alert("entered getAPIHandle() function");
   if (apiHandle == null)
   {
      apiHandle = getAPI();
   }
//alert("returning apiHandling and exiting getAPIHandle(). Value returned: " + apiHandle);
   return apiHandle;
}
...
function findAPI(win)
{
//alert("entering findAPI(win) function.")
...
//alert("returning win.API from findAPI(win) function. Returned: " + win.API);
   return win.API;
}
...
function getAPI()
{
//alert("entering getAPI() function");
...
//alert("returning value from getAPI() function. Returned: " + theAPI);
   return theAPI
}
